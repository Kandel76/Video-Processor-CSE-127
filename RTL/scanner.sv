module scan_controller #(
    ...
    input logic [(DATA_BITS*ADC_BANKS)-1:0] adc_data,  //dats from the ADC (under assumption of 1 bank)
    ...
    always_comb begin
        ...
        case (state_q)
            ...
            OUTPUT_PIXELS: begin
                ...
                if (all_pixels_output || !pixel_ready) begin
                    state_d = (step_cnt < STEPS_PER_ROW-1) ? START_CONVERT : NEXT_ROW;
                end
            end
