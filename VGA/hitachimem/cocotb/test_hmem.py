...
async def small_test(dut):
    ...
    for i in range(32):
        ...
        if (dut.rdata_o.value != i):
            print(" ! ERROR: expected value: ", i, " got value: ", int(dut.rdata_o.value))
    ...
    for i in range(1, 32):
        ...
        await RisingEdge(dut.clk)
        if (dut.rdata_o.value != i):
            print(" ! ERROR: expected value: ", hex(i), " got value: ", hex(int(dut.rdata_o.value)))
